...
function createResponse(options) {
  ...
  mockResponse.json = function(a, b) {
    ...
    mockResponse.status(status).send(msg);
  };
  ...
  */
  ...
  // FIXME - Simply adding the properties so things don't die
  mockResponse.connection = {};
  mockResponse.setTimeout = mockResponse.connection.setTimeout = function () {};
